...
import '@makekeeper/plugin-notify/frontend';
...
// The sidebar's main section is ordered by the order plugins register, so this
// line's position IS the calendar's position in it: above Statistics, with the
// two screens that answer "what is coming" and "what has been" side by side.
import '@makekeeper/plugin-schedule/frontend';
